...
namespace LinkedInApplication.Models.Main
{
    ...
    public partial class ComponentLanguageContent
    {
        ...
        [InverseProperty(nameof(LinkedInApplication.Models.Main.LanguageContentKey.ComponentLanguageContents))]
        ...
        [InverseProperty(nameof(LinkedInApplication.Models.Main.LanguageContent.ComponentLanguageContents))]
