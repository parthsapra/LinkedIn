...
//#region countryName Prop
        @gridColumn({visible: true, columnIndex:2, allowSorting: true, headerKey: 'countryName', keyColumn: false})
        countryName : string;
//#endregion countryName Prop


//#region cityId Prop
        @gridColumn({visible: true, columnIndex:3, allowSorting: true, headerKey: 'cityId', keyColumn: true})
        cityId : number;
